    ...
    public partial class identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecomandationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recomandation", x => x.RecomandationId);
                    table.ForeignKey(
                        name: "FK_Recomandation_Film_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Film",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Genre_RecomandationId",
                table: "Genre",
                column: "RecomandationId");

            migrationBuilder.CreateIndex(
                name: "IX_Recomandation_FilmId",
                table: "Recomandation",
                column: "FilmId");
        }
